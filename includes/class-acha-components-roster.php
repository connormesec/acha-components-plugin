...
class Acha_Components_Roster
{
    ...
    public function buildPlayerCardRoster()
    {
        ...
        if (isset($_GET['player']) && isset($_GET['team']) && isset($_GET['season'])) {
            ...
            function createPlayerCard($player_id, $team_id, $season_id, $headshot_image, $number, $name, $position, $hometown, $ht, $wt, $birthdate, $shoots, $last_team = null)
            {
                $player_card = '
        ...
        ';
            ...
            foreach ($roster_data->roster[0]->players as $player) {
                ...
                $content .= createPlayerCard($player->player_id, $roster_data->team_id, $roster_data->season_id, $headshot_image_link, $player->tp_jersey_number, $player->name, $player->position, $player->hometown, $player->height_hyphenated, $player->w, $player->birthdate, $player->shoots, $last_team);
            }
            //defense

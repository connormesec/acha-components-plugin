                ...
                <div class="row">
                    <div class="col-md-4">
                        <p>This will create a cron that will run twice daily. On each cron trigger, it will call an external api with the password provided. 
                            ...
                            The API will attempt to create posts with the user credentials so if the password is not the same as what the API is using then login will fail and no posts will be created.</p>
                    </div>
                    <div class="col-md-4">
                    <div class="mb-3 row">
